const CACHE_NAME = 'sudoku-indonesia-v1';
const urlsToCache = [
  '/',
  '/index.html',
  '/manifest.json',
...
async function syncGameData() {
  try {
    // Get pending sync data from IndexedDB if needed
    console.log('PWA: Syncing game data');
    // Implementation would go here if we had server sync
  } catch (error) {
